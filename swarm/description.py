...
config = {
    ...
    'w': 21},
  u'protocol_type':     {   'fieldname': u'protocol_type',
    'n': 121,
    'name': u'protocol_type',
    'type': 'SDRCategoryEncoder',
    'w': 21},
  u'service':     {   'fieldname': u'service',
    'n': 121,
    'name': u'service',
    'type': 'SDRCategoryEncoder',
    'w': 21},
  u'flag':     {   'fieldname': u'flag',
    'n': 121,
    'name': u'flag',
    'type': 'SDRCategoryEncoder',
    'w': 21},
  u'src_bytes':     {   'clipInput': True,
    'fieldname': u'src_bytes',
    'n': 100,
    'name': u'src_bytes',
    'type': 'AdaptiveScalarEncoder',
    'w': 21},
  u'dst_bytes':     {   'clipInput': True,
    'fieldname': u'dst_bytes',
    'n': 100,
    'name': u'dst_bytes',
    'type': 'AdaptiveScalarEncoder',
    'w': 21},
...
control = {
  ...
  #
  'dataset' : {   u'info': u'kdd_cup_99',
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'network intrusion',
                            u'source': u'file://network_intrusion_detection.csv'}],
        u'version': 1},
